...
const lodTxt = document.querySelector(".loadTxt");
let load = 0;
...
function blurring()
{
  ...
  lodTxt.innerHTML = `${load}%`;
  lodTxt.style.opacity = scale(load, 0, 100, 1, 0);
  pg.style.filter = `blur(${scale(load, 0, 100, 30, 0)}px)`;
}
